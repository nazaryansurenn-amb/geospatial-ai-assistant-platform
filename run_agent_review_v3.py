...
import json
import app
from wp_core.agent_service_v3 import AgentService, install_handler

ROOT=Path(__file__).resolve().parent
SLUG='agent_review_20260906_v3'

def main():
    for name in ['agent_review_20260906_v1','agent_review_20260906_v2',SLUG]:
