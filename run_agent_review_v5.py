...
import json
import app
from wp_core.agent_service_v5 import AgentService, install_handler

ROOT=Path(__file__).resolve().parent
SLUG='agent_review_20260906_v5'

def main():
    for name in ['agent_review_20260906_v1','agent_review_20260906_v2','agent_review_20260906_v3','agent_review_20260906_v4',SLUG]:
    ...
    def with_agent():
        ...
        app.DIST_ROOT=ROOT/'output/frontend_agent_review_20260906_v5'
        serve()
    app.main=with_agent
