"""Add 2021-2025 changes while retaining the current AI/Excel/hectare review."""
import os
...
import app
import run_agent_review_v5 as base
from wp_core import agent_service_v5
from wp_core.activity_change_history_agent import install
...
def main():
    ...
    install(agent_service_v5, summary, lookup)
    serve = app.main
