...
from wp_core import agent_knowledge_v6, agent_presentation_v6
from wp_core.activity_change_history_agent_v6 import install as install_history
...
def install(service, summary, lookup):
    ...
    facade = SimpleNamespace(clean_context=service.clean_context,
                             reader_context=agent_presentation_v6.reader_context,
                             instructions=agent_knowledge_v6.instructions)
