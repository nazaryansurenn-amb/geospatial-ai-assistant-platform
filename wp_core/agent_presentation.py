...
TAB_NAMES = {
 'hy': {'activity_2026':'2026 ակտիվություն','land_use_type':'Օգտագործման տեսակ','history_2021_2025':'2021–2025 պատմություն','potential':'Ներուժ','consolidation':'Հողատարածքների կոնսոլիդացիայի հնարավորություն'},
 'en': {'activity_2026':'2026 activity','land_use_type':'Use type','history_2021_2025':'2021–2025 history','potential':'Potential','consolidation':'Land consolidation opportunity'},
 'ru': {'activity_2026':'Активность в 2026 году','land_use_type':'Тип использования','history_2021_2025':'История за 2021–2025 годы','potential':'Потенциал','consolidation':'Возможность консолидации земель'},
}
