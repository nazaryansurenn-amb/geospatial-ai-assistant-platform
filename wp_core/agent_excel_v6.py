...
from wp_core.agent_queries_v6 import label
...
TOPICS={'activity':'2026 ակտիվություն','history':'Պատմություն՝ ըստ տարիների','history_summary':'2021–2025 պատմություն','use_type':'Օգտագործման տեսակ','cycles':'Տարեկան ցիկլեր','potential':'Ներուժ','consolidation':'Կոնսոլիդացիայի հնարավորություն','parcel':'Հողամաս','degradation':'Հողերի դեգրադացիայի հնարավոր նշաններ'}
