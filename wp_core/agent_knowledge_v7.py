...
import json
from wp_core.agent_scope import SCOPE_CONTRACT
...
available Lower Hrazdan study area, then the eight visible sections in ordinary language.
...
KNOWLEDGE = {
    'version': '8526-agent-20260907-v7',
    'hierarchy': {
    ...
    'interface': {
        'layers': 'Existing layers bar: canal I and II and their observed zones, territory selector, eight analysis tabs, thematic controls, cadastral base. Parcel click/search shows a cadastral profile.',
        'tabs': ['2026 ակտիվություն', 'Օգտագործման տեսակ', '2021–2025 պատմություն', 'Ներուժ', 'Հողատարածքների կոնսոլիդացիայի հնարավորություն', 'Մշակման փոփոխություն 2021–2025', 'Հողերի դեգրադացիայի հնարավոր նշաններ', 'Ոռոգման սթրեսի հնարավոր նշաններ'],
    ...
    'capabilities': {
        'calculate': 'Python filters communities, I/II scope, households, official parcel size, existing classes and available years; returns exact counts, hectares and percentages with denominators. Same result supports table/chart/Excel/map. No EO recalculation or changed rules.',
        'overview': 'For a comprehensive current-scope overview query activity, history_summary, use_type, potential, consolidation and degradation; discuss relationships as separate signals, not causal proof. Up to three requested geographic comparisons can be formed using actual tool results; do not invent zones.',
        ...
        'unavailable': 'No measured delivered volumes, irrigation event counts, applicable delivery norms, soil infiltration measurements, confirmed above-normative demand, real-time weather or forecast tool is connected to this agent. Do not claim those inputs are available. The requested high-water-loss section is not one of the active eight tabs. Optical/radar changes do not establish water consumption or irrigation counts. No crop identification, hydraulic design, new downloads or scheduled work is available.',
    },
    'rules': [
        ...
        'Roads remain excluded. Household land defaults to excluded and can be explicitly requested separately. Potential, consolidation and degradation always exclude households.',
        ...
        '250 m products are restricted to irrigation stress; never use them for parcel use type, activity, potential, consolidation or degradation. The agent does not recalculate any of these.',
        'The current irrigation-stress screening is one of the eight tabs. Keep it distinct from historical change and seven-day forecast risk; the latter is not an active calculated layer.',
    ],
}
...
Each tool result automatically creates a table/chart/Excel/map card. Do not promise an action not provided.
