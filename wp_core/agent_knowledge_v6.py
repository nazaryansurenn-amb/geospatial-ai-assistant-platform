...
available Lower Hrazdan study area, then the seven visible sections in ordinary language.
...
KNOWLEDGE = {
    'version': '8526-agent-20260906-v6',
    'hierarchy': {
    ...
    'interface': {
        'layers': 'Existing layers bar: canal I and II and their observed zones, territory selector, seven analysis tabs, thematic controls, cadastral base. Parcel click/search shows a cadastral profile.',
        'tabs': ['2026 ակտիվություն', 'Օգտագործման տեսակ', '2021–2025 պատմություն', 'Ներուժ', 'Հողատարածքների կոնսոլիդացիայի հնարավորություն', 'Մշակման փոփոխություն 2021–2025', 'Հողերի դեգրադացիայի հնարավոր նշաններ'],
    ...
    'capabilities': {
        ...
        'unavailable': 'No measured delivered volumes, irrigation event counts, applicable delivery norms, soil infiltration measurements, confirmed above-normative demand, real-time weather or forecast tool is connected to this agent. Do not claim those inputs are available. The requested high-water-loss section is not one of the active seven tabs. Optical/radar changes do not establish water consumption or irrigation counts. No crop identification, hydraulic design, new downloads or scheduled work is available.',
    },
    'rules': [
        ...
        'Keep current observed irrigation stress, historical change and seven-day forecast risk distinct whenever discussing them; none is a substitute for the active seven land tabs.',
    ],
}
