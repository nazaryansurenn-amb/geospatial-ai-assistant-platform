...
KNOWLEDGE = {
    'version': '8526-agent-20260906-v1',
    'hierarchy': {
...
scope overrides it; otherwise use current UI context. If asked for actively used hectares in 2026,
query activity for all classes and report observed_active_area_ha, its support and observation date;
