...
from wp_core.agent_knowledge_v6 import instructions
from wp_core.agent_excel_v6 import result_workbook
from wp_core.agent_presentation_v6 import reader_context, presentation_issues, rewrite_request
from wp_core.agent_scope import KINDS, REPLY_FORMAT, direct_kind, fixed_reply
from wp_core.agent_queries_v6 import CLASSES, TOPICS, SCOPES, COMMUNITY_NAMES, QueryError, build_result, parcel_result, persist_result
...
def clean_context(value):
    ...
    if mode not in ['activity_2026','history_2021_2025','land_use_type','potential','consolidation','degradation']:
...
class AgentService:
    ...
    def result_path(self,token,rid,kind):
        ...
        return ROOT/'server_data/agent_v6/results'/rid/name
