...
from wp_core.phenology_events import (
...
CONFIG = "config/phenology_events.json"
IDENTITY = ["internal_parcel_id", "cadastre_code", "area_official_m2", "household", "road_excluded"]
CODE = ["run_phenology_events.py", "verify_phenology_events.py", "wp_core/phenology_events.py"]
FORBIDDEN_MODULES = {"wp_core.observation_rules", "wp_core.observation_screening", "wp_core.phenology_transitions"}
...
def protected_hashes():
    ...
    hashes = {}
    for version in ("screening_20260906_v2", "transitions_20260906_v1", "transitions_20260906_v2", "transitions_20260906_v3"):
...
def main():
    ...
    if config["version"] != "events_20260906_v1" or config["years"] != list(range(2021, 2026)) or config["scope"] != "control_120":
    ...
    manifest = {"version": config["version"], "source": SOURCE, "comparison_only_after_prediction": COMPARISON,
