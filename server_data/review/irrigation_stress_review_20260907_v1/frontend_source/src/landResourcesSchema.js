...
export const LAND_MODES = [
  ...
  {
    id: "consolidation",
    label: "Հողատարածքների կոնսոլիդացիայի հնարավորություն",
    classes: [],
  },
  {
    id: "activity_change",
    label: "Մշակման փոփոխություն 2021–2025",
    classes: [],
  },
  {id: "degradation", label: "Հողերի դեգրադացիայի հնարավոր նշաններ", classes: []},
  {id:"irrigation_stress",label:"Ոռոգման սթրեսի հնարավոր նշաններ",classes:[]},
];
